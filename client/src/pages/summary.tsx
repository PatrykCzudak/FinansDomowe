...
export default function SummaryPage() {
  ...
  const dailyAverage = totalMonthlyExpenses / new Date().getDate();
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Wydatki w tym miesiącu</p>
                <p className="text-2xl font-bold text-gray-900">{totalMonthlyExpenses.toFixed(2)} zł</p>
                <p className="text-sm text-green-600">Bieżący miesiąc</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-green-600">W tym miesiącu</p>
              </div>
